...
exports.getLayoutByType = exports.editLayoutManager = exports.editLayout = exports.createLayoutManager = exports.createLayout = void 0;
...
// Create layout by manager
exports.createLayoutManager = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { type } = req.body;
        const isTypeExist = await layout_model_1.default.findOne({ type });
        if (isTypeExist) {
...
// Edit layout for manager
exports.editLayoutManager = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { type } = req.body;
        if (type === "Banner") {
            const bannerData = await layout_model_1.default.findOne({ type: "Banner" });
