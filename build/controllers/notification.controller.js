...
exports.updateNotification = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const notifications = await notification_model_1.default.find().sort({ craetedAt: -1 });
        res.status(201).json({
            success: true,
            notifications,
        });
...
node_cron_1.default.schedule("0 0 0 * * *", async () => {
    ...
    await notification_model_1.default.deleteMany({ status: "read", createAt: { $lt: thirtyDaysAgo } });
