...
courseRouter.post("/create-course-manager", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("manager"), course_controller_1.uploadCourseManager);
courseRouter.put("/edit-course/:id", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.editCourse);
courseRouter.put("/edit-course-manager/:id", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("manager"), course_controller_1.editCourseManager);
...
courseRouter.get("/get-manager-courses", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("manager"), course_controller_1.getAllCoursesManager);
...
courseRouter.delete("/delete-course-manager/:id", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("manager"), course_controller_1.deleteCourseManager);
